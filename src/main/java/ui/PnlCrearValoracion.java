...
public class PnlCrearValoracion extends JFrame implements ActionListener{

    String nombreActividad;
    String usuario;
    int valoracion;
    String comentario;
    public PnlCrearValoracion(String usuario, String nombreActividad, int valoracion, String comentario){
